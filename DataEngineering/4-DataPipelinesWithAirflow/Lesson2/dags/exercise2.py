...
dag = DAG(
    ...
    # TODO: Set an end date at December 1, 2020
    end_date=datetime.datetime(2020, 12, 1, 0, 0, 0, 0),
    # TODO: Set interval to run monthly
    schedule_interval="@monthly",
    # TODO: Set max active runs to 1... i.e., each DAG run happens one at a time
    max_active_runs=1
)
